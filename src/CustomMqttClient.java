...
public class CustomMqttClient implements MqttCallback {
    ...
    public CustomMqttClient (Consumer<HashMap<Object, Object>> fnc){
        this.FNC = fnc;
    }

    public CustomMqttClient init(String userName, String password, String serverURI, String clientId){
